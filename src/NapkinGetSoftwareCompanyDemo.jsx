...
const Specifications = () => {
  const specifications = [
    { label: 'Supported Platform', value: 'Web-based platform.' },
    { label: 'Devices', value: 'Accessible on desktops, laptops, and tablets' },
    { label: 'Deployment', value: 'Cloud-Based (SaaS)' },
    { label: 'Suitable for', value: ' Professionals and businesses seeking to enhance communication through visual storytelling' },
    { label: 'Business Size', value: 'NA' },
    { label: 'Setup Time', value: '' },
    { label: 'Customer Support', value: ' Premium support with direct access to the expert team available in higher-tier plans' },
    { label: 'Support Report Time', value: 'Not specified' },
    { label: 'Training', value: 'Not specified' },
    { label: 'Language', value: 'Not specified' },
    { label: 'Demographic', value: 'Global audience, business and professionals' }
  ];
...
const NipkinGetSoftwareCompanyDemo = ({
