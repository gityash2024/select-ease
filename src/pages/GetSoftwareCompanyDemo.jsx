...
const Specifications = () => {
  const specifications = [
    { label: 'Supported Platform', value: 'Windows, MacOS, Linux, iOS, Android' },
    { label: 'Devices', value: 'Desktop, Mobile, iPad, Tablet' },
    { label: 'Deployment', value: 'Web-Based, Perpetual' },
    { label: 'Suitable for', value: 'All Industries' },
    { label: 'Business Size', value: 'Small Business, Startups, Medium Business, Enterprises, SMBs, SMEs, MSMBs, MSMEs' },
