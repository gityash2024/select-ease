...
const Specifications = () => {
  const specifications = [
    { label: 'Supported Platform', value: 'Web-based platforms and offers API support.' },
    { label: 'Devices', value: 'Desktop, Laptops' },
    { label: 'Deployment', value: 'Cloud-Based (SaaS),Hybrid Deployment' },
    { label: 'Suitable for', value: 'Industries focused on automation, Customer engagement, and Compliance.' },
    { label: 'Business Size', value: '' },
    { label: 'Setup Time', value: '' },
    { label: 'Customer Support', value: 'Phone, Email, Live Chat, Communities' },
    { label: 'Support Report Time', value: '8-24 hours' },
    { label: 'Training', value: 'Webinars, Documentation, Videos' },
    { label: 'Language', value: '10+ languages' },
...
const QuickGetSoftwareCompanyDemo = ({
