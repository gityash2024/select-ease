...
const mockRatingsData = {
  ...
  companies: [
    { id: 1, name: "Taplio", color: "#4CAF50" },
    { id: 2, name: "Hypefury", color: "#FFC107" },
    { id: 3, name: "Shield App", color: "#F44336" },
...
const AmmplifyRating = ({ ratingsData = mockRatingsData }) => {
  const scrollLeft = () => {
