...
const mockFeaturesData = {
    categories: [
        ...
        },
        {
          ...
          features: [
            'No-code deployment',
            'Private AI agents running within enterprise infrastructure',
          ],
        },
        {
          id: 3,
        ...
        },
        {
          ...
          name: 'Customization',
          features: [
            'High-level customization of workflows',
            'Triggers',
            'Alerts',
          ],
        },
...
const LowtouchFeature = ({ featuresData = mockFeaturesData }) => {
  return (
    <Container>
      <FeatureSection>
...
export default LowtouchFeature;