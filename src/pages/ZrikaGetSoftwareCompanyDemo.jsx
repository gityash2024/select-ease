...
const Specifications = () => {
  const specifications = [
    ...
    { label: 'Deployment', value: 'Cloud-based deployment' },
    { label: 'Suitable for', value: 'Banks, Payment Aggregators, NBFCs, Digital Merchants' },
    { label: 'Business Size', value: '11-50 employees' },
    { label: 'Setup Time', value: '' },
    { label: 'Customer Support', value: '24/7 available' },
    { label: 'Support Report Time', value: 'Not specified' },
    { label: 'Training', value: 'No such information is available' },
    { label: 'Language', value: 'Supports multiple languages' },
    { label: 'Demographic', value: 'Primarily serves clients in India' }
  ];
...
const ZrikaGetSoftwareCompanyDemo = ({
