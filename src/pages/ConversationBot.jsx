...
import quicksmartlogo from '../assets/quicksmartlogo.png'
  ...
  const products = [
    {
        ...
        description:
          'QuickSmart.ai is a pioneering company specializing in the integration of artificial intelligence with SIP trunk telephony. We leverage over a decade of expertise to provide advanced, AI-driven communication solutions that enhance efficiency, reliability, and intelligence in business interactions.',
        actions: ['Read Reviews', 'Get Free Demo'],
      },
      {
        id: 2,
        logo: scogologo,
        title: 'Scogo.ai',
        sub: 'AI-Powered Support Platform',
        rating: 4.2,
        reviews: 25,
        description:
          'Scogo.ai is on a mission to build and deliver AI solutions as easy and cost-effective as SaaS, empowering businesses to win customers and reach new markets.',
        actions: ['Read Reviews', 'Buy Now'],
      },
      {
        id: 3,
        logo: lowtouchlogo,
        title: 'Lowtouch.ai',
        sub: 'No-Code AI Platform',
        rating: 4.3,
        reviews: 21,
  ...
  return (
    <PageWrapper>
      <HeroSection>
        ...
        <p>
        Smart AI chatbots that understand natural language and automate customer support, lead generation, and internal queries. From websites to WhatsApp, these bots engage users 24/7, reduce human workload, and improve customer satisfaction.
        </p>
      </HeroSection>
...
export default CapversationBot;
